...
\begin{tikzpicture}
    \begin{axis}[anchor=origin, xlabel=$t$,ylabel=$y$,grid=major,ymin=0,ymax=1,height=5cm,width=5cm]
...
\end{axis}
\draw (10,3) node[left]{\textdownstep распределение броуновского моста} ;
\end{tikzpicture}
